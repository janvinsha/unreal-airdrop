...
string memory description,
    ...
    require(collections[collectionId].owner==msg.sender,"You can only edit your collection");

   collections[collectionId].banner=banner;
   collections[collectionId].dp=dp;
   collections[collectionId].name=name;
   collections[collectionId].totalSupply=totalSupply;
    collections[collectionId].noHolders=noHolders;
 collections[collectionId].description=description;
  collections[collectionId].tags=tags;
}
...
function getProfile(address id) public view returns(Profile memory){
    ...
    function createToken(string memory tokenURI, uint256 price,uint256 collectionId,
     string memory name,
      ...
      createMarketItem(newTokenId, price, collectionId,  name,
      category,
      description,
      tags);
      return newTokenId;
